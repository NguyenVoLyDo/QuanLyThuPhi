...
// Use database data if no old data passed back
if (empty($old)) {
    $old = $fee_type;
}
?>
    ...
    <div class="col-md-8">
        <div class="card shadow-sm">
            <div class="card-header bg-white">
                <h5 class="mb-0"><i class="fas fa-edit"></i> Chỉnh sửa khoản thu</h5>
            </div>
            
            <div class="card-body">
                <form method="POST" action="<?php echo app_url("index.php"); ?>?controller=feetype&action=update">
                    <input type="hidden" name="id" value="<?php echo $fee_type['id']; ?>">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="fee_name" class="form-control <?php echo isset($errors['fee_name']) ? 'is-invalid' : ''; ?>" 
                                   value="<?php echo htmlspecialchars($old['fee_name'] ?? ''); ?>">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="academic_year" class="form-control <?php echo isset($errors['academic_year']) ? 'is-invalid' : ''; ?>" 
                                   value="<?php echo htmlspecialchars($old['academic_year'] ?? ''); ?>">
                        ...
                        <div class="col-md-9">
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="is_mandatory" id="isMandatory" value="1"
                                       <?php echo (isset($old['is_mandatory']) && $old['is_mandatory']) ? 'checked' : ''; ?>>
