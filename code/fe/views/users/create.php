...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo app_url("index.php"); ?>?controller=user&action=store">
                    ...
                    <div class="row mb-3">
                        <label class="col-md-3 col-form-label">Mật khẩu <span class="text-danger">*</span></label>
                        <div class="col-md-9">
                            ...
                            <select name="class_id" class="form-select">
                                ...
                                <?php foreach ($classes as $class): ?>
                                    <option value="<?php echo $class['id']; ?>" 
                                            <?php echo (isset($old['class_id']) && $old['class_id'] == $class['id']) ? 'selected' : ''; ?>>
                                        <?php echo $class['class_name'] . ' (' . ($class['teacher_name'] ? 'GV: ' . $class['teacher_name'] : 'Chưa có GV') . ')'; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            <div class="form-text">Chọn lớp để phân công làm giáo viên chủ nhiệm. Nếu lớp đã có GV, GV cũ sẽ bị thay thế.</div>
                        </div>
                    </div>
