...
class User {
    ...
    /**
     * Cập nhật thông tin profile (chỉ các field công khai)
     */
    ...
    public function changePassword($user_id, $old_pass, $new_pass) {
        ...
        $update_query = "UPDATE {$this->table} SET password = :password WHERE id = :id";
    ...
    public function resetPassword($id) {
        ...
        if ($stmt->execute()) {
            return ['success' => true, 'message' => 'Đã reset mật khẩu về 123456'];
        }
        return ['success' => false, 'message' => 'Lỗi database!'];
    }
